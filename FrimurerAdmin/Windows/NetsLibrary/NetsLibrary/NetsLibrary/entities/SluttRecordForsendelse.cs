...
{
    public class SluttRecordForsendelse:BaseEntity
    {
        ...
        public String Filler
        {
            get
            {
                return filler.PadLeft(33, '0');
            }
        }

   

        public SluttRecordForsendelse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(Debug+ FormatKode+TjenesteKode+ForsendelsesType+RecordType+AntallTransaksjoner+ AntallRecords+ SumBeløp+ FørsteDato+ Filler);
            return sb.ToString();
        }
    }
}
